...
type ExampleServiceServer interface {
	...
	DeleteExample(ctx context.Context, req *v1.DeleteExampleRequest) (*v1.DeleteExampleResponse, error)
	GetExample(ctx context.Context, req *v1.GetExampleRequest) (*v1.GetExampleResponse, error)
}
...
func RegisterExampleServiceHandler(s *mcpserver.MCPServer, srv ExampleServiceServer) {
	...
	s.AddTool(ExampleService_DeleteExampleTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		var req v1.DeleteExampleRequest
		...
		resp, err := srv.DeleteExample(ctx, &req)
		if err != nil {
			return nil, err
		}
	...
	s.AddTool(ExampleService_GetExampleTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		var req v1.GetExampleRequest
		...
		resp, err := srv.GetExample(ctx, &req)
		if err != nil {
			return nil, err
		}
...
type ExampleServiceClient interface {
	...
	DeleteExample(ctx context.Context, req *v1.DeleteExampleRequest, opts ...grpc.CallOption) (*v1.DeleteExampleResponse, error)
	GetExample(ctx context.Context, req *v1.GetExampleRequest, opts ...grpc.CallOption) (*v1.GetExampleResponse, error)
}
...
type ConnectExampleServiceClient interface {
	...
	DeleteExample(ctx context.Context, req *connect.Request[v1.DeleteExampleRequest]) (*connect.Response[v1.DeleteExampleResponse], error)
	GetExample(ctx context.Context, req *connect.Request[v1.GetExampleRequest]) (*connect.Response[v1.GetExampleResponse], error)
}
...
func ForwardToConnectExampleServiceClient(s *mcpserver.MCPServer, client ConnectExampleServiceClient) {
	...
	s.AddTool(ExampleService_DeleteExampleTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		resp, err := client.DeleteExample(ctx, connect.NewRequest(&req))
		if err != nil {
			return nil, err
		}
	...
	s.AddTool(ExampleService_GetExampleTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		resp, err := client.GetExample(ctx, connect.NewRequest(&req))
		if err != nil {
			return nil, err
		}
...
func ForwardToExampleServiceClient(s *mcpserver.MCPServer, client ExampleServiceClient) {
	...
	s.AddTool(ExampleService_DeleteExampleTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		resp, err := client.DeleteExample(ctx, &req)
		if err != nil {
			return nil, err
		}
